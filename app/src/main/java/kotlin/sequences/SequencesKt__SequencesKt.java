...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    static final class C01021<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C01021(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0, Continuation<? super C01021> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01021 c01021 = new C01021(this.$this_ifEmpty, this.$defaultValue, continuation);
            c01021.L$0 = obj;
            return c01021;
        }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt.sequence(new C01021(sequence, defaultValue, null));
    }
    ...
    static final class C01031<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C01031(Sequence<? extends T> sequence, Random random, Continuation<? super C01031> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01031 c01031 = new C01031(this.$this_shuffled, this.$random, continuation);
            c01031.L$0 = obj;
            return c01031;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(SequenceScope<? super T> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C01031) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    c01031 = this;
                    sequenceScope = (SequenceScope) c01031.L$0;
                    mutableList = SequencesKt.toMutableList(c01031.$this_shuffled);
                    break;
                case 1:
                    c01031 = this;
                    mutableList = (List) c01031.L$1;
                    SequenceScope sequenceScope2 = (SequenceScope) c01031.L$0;
                    ResultKt.throwOnFailure(obj);
            ...
            while (!mutableList.isEmpty()) {
                int iNextInt = c01031.$random.nextInt(mutableList.size());
                ...
                c01031.L$0 = sequenceScope;
                c01031.L$1 = mutableList;
                c01031.label = 1;
                if (sequenceScope.yield(objRemoveLast, c01031) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            return Unit.INSTANCE;
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> sequence, Random random) {
        ...
        return SequencesKt.sequence(new C01031(sequence, random, null));
    }
    ...
    static final class C00981<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00981(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1, Continuation<? super C00981> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00981 c00981 = new C00981(this.$source, this.$transform, this.$iterator, continuation);
            c00981.L$0 = obj;
            return c00981;
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    c00981 = this;
                    sequenceScope = (SequenceScope) c00981.L$0;
                    i = 0;
                    it = c00981.$source.iterator();
                    break;
                case 1:
                    c00981 = this;
                    i = c00981.I$0;
                    it = (Iterator) c00981.L$1;
                    sequenceScope = (SequenceScope) c00981.L$0;
                    ResultKt.throwOnFailure(obj);
                    break;
                default:
            ...
            while (it.hasNext()) {
                Object next = it.next();
                Function2<Integer, T, C> function2 = c00981.$transform;
                int i2 = i + 1;
                if (i < 0) {
                    CollectionsKt.throwIndexOverflow();
                }
                Object objInvoke = function2.invoke(Boxing.boxInt(i), (T) next);
                c00981.L$0 = sequenceScope;
                c00981.L$1 = it;
                c00981.I$0 = i2;
                c00981.label = 1;
                if (sequenceScope.yieldAll(c00981.$iterator.invoke((C) objInvoke), c00981) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                i = i2;
            }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> source, Function2<? super Integer, ? super T, ? extends C> transform, Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        Intrinsics.checkNotNullParameter(iterator, "iterator");
        return SequencesKt.sequence(new C00981(source, transform, iterator, null));
    }
