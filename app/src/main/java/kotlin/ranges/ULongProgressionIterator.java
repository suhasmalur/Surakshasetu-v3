...
final class ULongProgressionIterator implements Iterator<ULong>, KMappedMarker {
    ...
    private ULongProgressionIterator(long first, long last, long step) {
        ...
        this.hasNext = z;
        this.step = ULong.m638constructorimpl(step);
        this.next = this.hasNext ? first : this.finalElement;
    }

    @Override // java.util.Iterator
    public /* bridge */ /* synthetic */ ULong next() {
        return ULong.m632boximpl(m1699nextsVKNKU());
    }
    ...
    public long m1699nextsVKNKU() {
        ...
        if (value == this.finalElement) {
            ...
            this.next = ULong.m638constructorimpl(this.next + this.step);
        }
        return value;
    }
}
