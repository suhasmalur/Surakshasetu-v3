...
public final class Regex implements Serializable {
    ...
    public final Sequence<String> splitToSequence(CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt.sequence(new C01251(input, limit, null));
    }
    ...
    static final class C01251 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01251(CharSequence charSequence, int i, Continuation<? super C01251> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01251 c01251 = Regex.this.new C01251(this.$input, this.$limit, continuation);
            c01251.L$0 = obj;
            return c01251;
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r11) throws java.lang.Throwable {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlin.text.Regex.C01251.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
