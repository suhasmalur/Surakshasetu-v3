...
public final class UnsignedKt {
    ...
    public static final int m815uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m559constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }

    /* JADX INFO: renamed from: uintRemainder-J1ME1BU, reason: not valid java name */
    public static final int m816uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m559constructorimpl((int) ((((long) v1) & 4294967295L) % (4294967295L & ((long) v2))));
    }

    /* JADX INFO: renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m817ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m638constructorimpl(Long.compare(v1 ^ Long.MIN_VALUE, v2 ^ Long.MIN_VALUE) >= 0 ? 1L : 0L);
        }
        if (v1 >= 0) {
            return ULong.m638constructorimpl(v1 / v2);
        }
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        return ULong.m638constructorimpl(((long) (Long.compare(ULong.m638constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m638constructorimpl(v2) ^ Long.MIN_VALUE) < 0 ? 0 : 1)) + quotient);
    }

    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m818ulongRemaindereb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
        ...
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        if (Long.compare(ULong.m638constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m638constructorimpl(v2) ^ Long.MIN_VALUE) >= 0) {
            j = v2;
        }
        return ULong.m638constructorimpl(rem - j);
    }
    ...
    public static final int doubleToUInt(double v) {
        ...
        return v <= 2.147483647E9d ? UInt.m559constructorimpl((int) v) : UInt.m559constructorimpl(UInt.m559constructorimpl((int) (v - ((double) Integer.MAX_VALUE))) + UInt.m559constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double v) {
        ...
        return v < 9.223372036854776E18d ? ULong.m638constructorimpl((long) v) : ULong.m638constructorimpl(ULong.m638constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
