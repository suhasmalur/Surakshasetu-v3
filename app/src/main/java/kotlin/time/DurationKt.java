...
public final class DurationKt {
    ...
    private static final long m1917timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m1828timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m1916timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m1827timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }
    ...
    */
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m1790constructorimpl(normalNanos << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long normalMillis) {
        return Duration.m1790constructorimpl((normalMillis << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m1790constructorimpl((normalValue << 1) + ((long) unitDiscriminator));
    }
