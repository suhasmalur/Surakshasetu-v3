...
public interface SendChannel<E> {
    ...
    Object mo1970trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo1970trySendJP2dKIU(e);
            if (ChannelResult.m1985isSuccessimpl(result)) {
                return true;
            }
            Throwable thM1979exceptionOrNullimpl = ChannelResult.m1979exceptionOrNullimpl(result);
