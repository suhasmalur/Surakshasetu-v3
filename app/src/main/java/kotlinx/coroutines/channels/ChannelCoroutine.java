...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo1968receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo1968receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo1969tryReceivePtdJZtk() {
        return this._channel.mo1969tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo1970trySendJP2dKIU(E element) {
        return this._channel.mo1970trySendJP2dKIU(element);
    }
