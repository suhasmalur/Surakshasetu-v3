...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM464constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM464constructorimpl = Result.m464constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM464constructorimpl = Result.m464constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m467exceptionOrNullimpl(objM464constructorimpl) == null) {
            obj2 = objM464constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM464constructorimpl2 = Result.m464constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM464constructorimpl2 = Result.m464constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m467exceptionOrNullimpl(objM464constructorimpl2) == null) {
            obj = objM464constructorimpl2;
        }
