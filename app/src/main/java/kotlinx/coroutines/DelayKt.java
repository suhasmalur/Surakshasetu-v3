    ...
    */
    ...
    public static final Object delay(long timeMillis, Continuation<? super Unit> continuation) {
        ...
        if (timeMillis < Long.MAX_VALUE) {
            getDelay(cont.getContext()).mo2017scheduleResumeAfterDelay(timeMillis, cont);
        }
    ...
    public static final Object m1954delayVtjQ1oo(long duration, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1955toDelayMillisLRDsOJo(duration), continuation);
    ...
    public static final long m1955toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        if (Duration.m1789compareToLRDsOJo($this$toDelayMillis_u2dLRDsOJo, Duration.INSTANCE.m1893getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1808getInWholeMillisecondsimpl($this$toDelayMillis_u2dLRDsOJo), 1L);
        }
        return 0L;
    }
}
