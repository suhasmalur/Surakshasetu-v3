...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    private final class Core {
        ...
        private final void removeCleanedAt(int index) {
            ...
            } while (!Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(this.values, index, oldValue, null));
        ...
        public final Object putImpl(K key, V value, HashedWeakRef<K> weakKey0) {
            ...
            while (true) {
                ...
                if (w != null) {
                    ...
                    if (Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(this.keys, index, null, hashedWeakRef)) {
                        break;
                    }
                }
            }
            ...
            } while (!Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(this.values, index, oldValue, value));
            return oldValue;
        }
