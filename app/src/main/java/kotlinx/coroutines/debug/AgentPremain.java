...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM464constructorimpl = Result.m464constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM464constructorimpl = Result.m464constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m470isFailureimpl(objM464constructorimpl) ? null : objM464constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1993installSignalHandler$lambda1(signal);
                }
            });
        } catch (Throwable th) {
        }
    ...
    public static final void m1993installSignalHandler$lambda1(Signal it) {
