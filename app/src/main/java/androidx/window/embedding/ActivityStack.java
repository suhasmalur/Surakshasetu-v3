...
public final class ActivityStack {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof ActivityStack) {
            return (Intrinsics.areEqual(this.activities, ((ActivityStack) other).activities) || this.isEmpty == ((ActivityStack) other).isEmpty) ? false : true;
        }
        return false;
    }
