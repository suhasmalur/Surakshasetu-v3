...
public final class SplitInfo {
    ...
    public int hashCode() {
        ...
        return (((result * 31) + this.secondaryActivityStack.hashCode()) * 31) + Float.hashCode(this.splitRatio);
    }
