...
public final class ActivityFilter {
    ...
    public final boolean matchesIntent(Intent intent) {
        ...
        boolean z = false;
        if (MatcherUtils.INSTANCE.areComponentsMatching$window_release(intent.getComponent(), this.componentName) && (this.intentAction == null || Intrinsics.areEqual(this.intentAction, intent.getAction()))) {
            z = true;
        }
        boolean match = z;
        return match;
