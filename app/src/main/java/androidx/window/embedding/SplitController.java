...
public final class SplitController {
    ...
    public static final class Companion {
        ...
        public final void initialize(Context context, int staticRuleResourceId) {
            ...
            Set<EmbeddingRule> splitRules$window_release = parser.parseSplitRules$window_release(context, staticRuleResourceId);
            SplitController controllerInstance = getInstance();
            controllerInstance.setStaticSplitRules(splitRules$window_release == null ? SetsKt.emptySet() : splitRules$window_release);
        }
    }
}
