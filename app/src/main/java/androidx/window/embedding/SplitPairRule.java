...
public final class SplitPairRule extends SplitRule {
    ...
    public int hashCode() {
        ...
        return (((((((result * 31) + this.filters.hashCode()) * 31) + Boolean.hashCode(this.finishPrimaryWithSecondary)) * 31) + Boolean.hashCode(this.finishSecondaryWithPrimary)) * 31) + Boolean.hashCode(this.clearTop);
    }
}
