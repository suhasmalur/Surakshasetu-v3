...
public final class EmbeddingAdapter {
    ...
    public final Predicate<Pair<Activity, Activity>> translateActivityPairPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda2
            ...
            public final boolean test(Object obj) {
                return EmbeddingAdapter.m87translateActivityPairPredicates$lambda1(this.f$0, splitPairFilters, (Pair) obj);
            }
        };
    }
    ...
    public static final boolean m87translateActivityPairPredicates$lambda1(EmbeddingAdapter this$0, Set splitPairFilters, Pair $dstr$first$second) {
    ...
    public final Predicate<Pair<Activity, Intent>> translateActivityIntentPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda3
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return EmbeddingAdapter.m86translateActivityIntentPredicates$lambda3(this.f$0, splitPairFilters, (Pair) obj);
            }
        };
    }
    ...
    public static final boolean m86translateActivityIntentPredicates$lambda3(EmbeddingAdapter this$0, Set splitPairFilters, Pair $dstr$first$second) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(splitPairFilters, "$splitPairFilters");
        Intrinsics.checkNotNullExpressionValue($dstr$first$second, "(first, second)");
        Activity first = (Activity) this$0.component1($dstr$first$second);
    ...
    public final Predicate<WindowMetrics> translateParentMetricsPredicate(final SplitRule splitRule) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda1
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return EmbeddingAdapter.m90translateParentMetricsPredicate$lambda4(splitRule, (WindowMetrics) obj);
            }
        };
    }
    ...
    public static final boolean m90translateParentMetricsPredicate$lambda4(SplitRule splitRule, WindowMetrics windowMetrics) {
        Intrinsics.checkNotNullParameter(splitRule, "$splitRule");
    ...
    public final Predicate<Activity> translateActivityPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda4
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return EmbeddingAdapter.m88translateActivityPredicates$lambda6(activityFilters, (Activity) obj);
            }
        };
    }
    ...
    public static final boolean m88translateActivityPredicates$lambda6(Set activityFilters, Activity activity) {
        Intrinsics.checkNotNullParameter(activityFilters, "$activityFilters");
    ...
    public final Predicate<Intent> translateIntentPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda0
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return EmbeddingAdapter.m89translateIntentPredicates$lambda8(activityFilters, (Intent) obj);
            }
        };
    }
    ...
    public static final boolean m89translateIntentPredicates$lambda8(Set activityFilters, Intent intent) {
        Intrinsics.checkNotNullParameter(activityFilters, "$activityFilters");
        Set $this$any$iv = activityFilters;
        if (($this$any$iv instanceof Collection) && $this$any$iv.isEmpty()) {
            return false;
    ...
    public final Set<androidx.window.extensions.embedding.EmbeddingRule> translate(Set<? extends EmbeddingRule> rules) {
        ...
        for (Object item$iv$iv : $this$map$iv) {
            ...
            if (rule instanceof SplitPairRule) {
                splitPairRuleBuild = new SplitPairRule.Builder(translateActivityPairPredicates(((SplitPairRule) rule).getFilters()), translateActivityIntentPredicates(((SplitPairRule) rule).getFilters()), translateParentMetricsPredicate((SplitRule) rule)).setSplitRatio(((SplitPairRule) rule).getSplitRatio()).setLayoutDirection(((SplitPairRule) rule).getLayoutDirection()).setShouldFinishPrimaryWithSecondary(((SplitPairRule) rule).getFinishPrimaryWithSecondary()).setShouldFinishSecondaryWithPrimary(((SplitPairRule) rule).getFinishSecondaryWithPrimary()).setShouldClearTop(((SplitPairRule) rule).getClearTop()).build();
                ...
                splitPairRuleBuild = new ActivityRule.Builder(translateActivityPredicates(((ActivityRule) rule).getFilters()), translateIntentPredicates(((ActivityRule) rule).getFilters())).setShouldAlwaysExpand(((ActivityRule) rule).getAlwaysExpand()).build();
                Intrinsics.checkNotNullExpressionValue(splitPairRuleBuild, "ActivityRuleBuilder(\n   …                 .build()");
            } else {
                throw new IllegalArgumentException("Unsupported rule type");
            }
            destination$iv$iv.add((androidx.window.extensions.embedding.EmbeddingRule) splitPairRuleBuild);
        }
