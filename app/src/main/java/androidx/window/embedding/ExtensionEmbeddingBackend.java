...
public final class ExtensionEmbeddingBackend implements EmbeddingBackend {
    ...
    public static final class SplitListenerWrapper {
        ...
        public final void accept(List<SplitInfo> splitInfoList) {
            ...
            this.executor.execute(new Runnable() { // from class: androidx.window.embedding.ExtensionEmbeddingBackend$SplitListenerWrapper$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    ExtensionEmbeddingBackend.SplitListenerWrapper.m91accept$lambda1(this.f$0, splitsWithActivity);
                }
            });
        }
        ...
        public static final void m91accept$lambda1(SplitListenerWrapper this$0, List splitsWithActivity) {
    ...
    public final class EmbeddingCallbackImpl implements EmbeddingInterfaceCompat.EmbeddingCallbackInterface {
        ...
        public void onSplitInfoChanged(List<SplitInfo> splitInfo) {
            ...
            for (SplitListenerWrapper callbackWrapper : this.this$0.getSplitChangeCallbacks()) {
