...
public final class SidecarWindowBackend implements WindowBackend {
        ...
        try {
            ...
            if (isActivityRegistered) {
                ...
                if (windowLayoutChangeCallbackWrapper != null) {
                    lastInfo = windowLayoutChangeCallbackWrapper.getLastInfo();
                }
                WindowLayoutInfo lastInfo2 = lastInfo;
                if (lastInfo2 != null) {
                    callbackWrapper.accept(lastInfo2);
                }
            } else {
    ...
    public final class ExtensionListenerImpl implements ExtensionInterfaceCompat.ExtensionCallbackInterface {
        ...
        public void onWindowLayoutChanged(Activity activity, WindowLayoutInfo newLayout) {
            ...
            for (WindowLayoutChangeCallbackWrapper callbackWrapper : this.this$0.getWindowLayoutChangeCallbacks()) {
                if (Intrinsics.areEqual(callbackWrapper.getActivity(), activity)) {
    ...
    public static final class WindowLayoutChangeCallbackWrapper {
        ...
        public final void accept(final WindowLayoutInfo newLayoutInfo) {
            ...
            this.executor.execute(new Runnable() { // from class: androidx.window.layout.SidecarWindowBackend$WindowLayoutChangeCallbackWrapper$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    SidecarWindowBackend.WindowLayoutChangeCallbackWrapper.m93accept$lambda0(this.f$0, newLayoutInfo);
                }
            });
        }
        ...
        public static final void m93accept$lambda0(WindowLayoutChangeCallbackWrapper this$0, WindowLayoutInfo newLayoutInfo) {
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            Intrinsics.checkNotNullParameter(newLayoutInfo, "$newLayoutInfo");
