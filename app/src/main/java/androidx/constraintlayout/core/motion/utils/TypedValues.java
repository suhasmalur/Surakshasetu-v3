...
public interface TypedValues {
    ...
    public interface AttributesType {
        ...
        static int getId(String name) {
            ...
            switch (name.hashCode()) {
                case -1310311125:
                    b = !name.equals("easing") ? (byte) -1 : Ascii.DLE;
                    break;
                case -1249320806:
                    b = !name.equals("rotationX") ? (byte) -1 : (byte) 7;
                    break;
                case -1249320805:
                    b = !name.equals("rotationY") ? (byte) -1 : (byte) 8;
                    break;
                case -1249320804:
                    b = !name.equals("rotationZ") ? (byte) -1 : (byte) 9;
                    break;
                case -1225497657:
                ...
                case -1225497655:
                    ...
                    break;
                case -1001078227:
                    b = !name.equals("progress") ? (byte) -1 : Ascii.SO;
                    break;
                case -987906986:
                    b = !name.equals("pivotX") ? (byte) -1 : Ascii.FF;
                    break;
                case -987906985:
                    b = !name.equals("pivotY") ? (byte) -1 : Ascii.CR;
                    break;
                case -908189618:
                    b = !name.equals("scaleX") ? (byte) -1 : (byte) 10;
                    break;
                case -908189617:
                    b = !name.equals("scaleY") ? (byte) -1 : Ascii.VT;
                    break;
                case -880905839:
                    b = !name.equals(S_TARGET) ? (byte) -1 : Ascii.DC2;
                    break;
                case -4379043:
                    b = !name.equals("elevation") ? (byte) -1 : (byte) 6;
                    break;
                case 92909918:
                    b = !name.equals("alpha") ? (byte) -1 : (byte) 2;
                    break;
                case 97692013:
                    b = !name.equals(S_FRAME) ? (byte) -1 : (byte) 17;
                    break;
                case 579057826:
                    b = !name.equals("curveFit") ? (byte) -1 : (byte) 0;
                    break;
                case 803192288:
                    b = !name.equals("pathRotate") ? (byte) -1 : Ascii.SI;
                    break;
                case 1167159411:
                    b = !name.equals(S_PIVOT_TARGET) ? (byte) -1 : (byte) 19;
                    break;
                case 1941332754:
    ...
    public interface TriggerType {
        ...
        static int getId(String name) {
            ...
            switch (name.hashCode()) {
                case -1594793529:
                    b = !name.equals("positiveCross") ? (byte) -1 : (byte) 8;
                    break;
                case -966421266:
                    b = !name.equals("viewTransitionOnPositiveCross") ? (byte) -1 : (byte) 1;
                    break;
                case -786670827:
                    b = !name.equals("triggerCollisionId") ? (byte) -1 : (byte) 6;
                    break;
                case -648752941:
                    b = !name.equals("triggerID") ? (byte) -1 : (byte) 7;
                    break;
                case -638126837:
                    b = !name.equals("negativeCross") ? (byte) -1 : (byte) 9;
                    break;
                case -76025313:
                    b = !name.equals("triggerCollisionView") ? (byte) -1 : (byte) 5;
                    break;
                case -9754574:
                    b = !name.equals("viewTransitionOnNegativeCross") ? (byte) -1 : (byte) 2;
                    break;
                case 64397344:
                    b = !name.equals("CROSS") ? (byte) -1 : Ascii.VT;
                    break;
                case 364489912:
                    b = !name.equals("triggerSlack") ? (byte) -1 : (byte) 4;
                    break;
                case 1301930599:
                    b = !name.equals("viewTransitionOnCross") ? (byte) -1 : (byte) 0;
                    break;
                case 1401391082:
                    b = !name.equals("postLayout") ? (byte) -1 : (byte) 3;
                    break;
                case 1535404999:
                    b = !name.equals("triggerReceiver") ? (byte) -1 : (byte) 10;
                    break;
                default:
                    b = -1;
                    break;
    ...
    public interface MotionType {
        ...
        static int getId(String name) {
            ...
            switch (name.hashCode()) {
                case -2033446275:
                    b = !name.equals(S_ANIMATE_CIRCLEANGLE_TO) ? (byte) -1 : (byte) 6;
                    break;
                case -1532277420:
                    b = !name.equals(S_QUANTIZE_MOTION_PHASE) ? (byte) -1 : (byte) 2;
                    break;
                case -1529145600:
                    b = !name.equals(S_QUANTIZE_MOTIONSTEPS) ? (byte) -1 : (byte) 10;
                    break;
                case -1498310144:
                    b = !name.equals(S_PATH_ROTATE) ? (byte) -1 : (byte) 1;
                    break;
                case -1030753096:
                    b = !name.equals(S_QUANTIZE_INTERPOLATOR) ? (byte) -1 : (byte) 4;
                    break;
                case -762370135:
                    b = !name.equals(S_DRAW_PATH) ? (byte) -1 : (byte) 8;
                    break;
                case -232872051:
                    b = !name.equals(S_STAGGER) ? (byte) -1 : (byte) 0;
                    break;
                case 1138491429:
                    b = !name.equals(S_POLAR_RELATIVETO) ? (byte) -1 : (byte) 9;
                    break;
                case 1539234834:
                    b = !name.equals(S_QUANTIZE_INTERPOLATOR_TYPE) ? (byte) -1 : Ascii.VT;
                    break;
                case 1583722451:
                    b = !name.equals(S_QUANTIZE_INTERPOLATOR_ID) ? (byte) -1 : Ascii.FF;
                    break;
                case 1639368448:
                    b = !name.equals(S_EASING) ? (byte) -1 : (byte) 3;
                    break;
                case 1900899336:
                    b = !name.equals(S_ANIMATE_RELATIVE_TO) ? (byte) -1 : (byte) 5;
                    break;
                case 2109694967:
                    b = !name.equals(S_PATHMOTION_ARC) ? (byte) -1 : (byte) 7;
                    break;
                default:
                    b = -1;
                    break;
