...
public final class NavDeepLinkDslBuilder {
    ...
    public final NavDeepLink build$navigation_common_release() {
        NavDeepLink.Builder $this$build_u24lambda_u244 = this.builder;
        if (!((this.uriPattern == null && this.action == null && this.mimeType == null) ? false : true)) {
            throw new IllegalStateException("The NavDeepLink must have an uri, action, and/or mimeType.".toString());
        }
        String it = this.uriPattern;
        if (it != null) {
            $this$build_u24lambda_u244.setUriPattern(it);
        }
        String it2 = this.action;
        if (it2 != null) {
            $this$build_u24lambda_u244.setAction(it2);
        }
        String it3 = this.mimeType;
        if (it3 != null) {
            $this$build_u24lambda_u244.setMimeType(it3);
        }
        return $this$build_u24lambda_u244.build();
    }
}
