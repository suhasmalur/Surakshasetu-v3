...
public abstract class AbstractListDetailFragment extends Fragment {
    ...
    public final NavHostFragment getDetailPaneNavHostFragment() {
        if (this._detailPaneNavHostFragment == null) {
    ...
    /* JADX INFO: compiled from: AbstractListDetailFragment.kt */
    @Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0007\n\u0000\b\u0002\u0018\u00002\u00020\u00012\u00020\u0002B\r\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0002\u0010\u0005J\b\u0010\u0006\u001a\u00020\u0007H\u0016J\u0010\u0010\b\u001a\u00020\u00072\u0006\u0010\t\u001a\u00020\nH\u0016J\u0010\u0010\u000b\u001a\u00020\u00072\u0006\u0010\t\u001a\u00020\nH\u0016J\u0018\u0010\f\u001a\u00020\u00072\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\r\u001a\u00020\u000eH\u0016R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000f"}, d2 = {"Landroidx/navigation/fragment/AbstractListDetailFragment$InnerOnBackPressedCallback;", "Landroidx/activity/OnBackPressedCallback;", "Landroidx/slidingpanelayout/widget/SlidingPaneLayout$PanelSlideListener;", "slidingPaneLayout", "Landroidx/slidingpanelayout/widget/SlidingPaneLayout;", "(Landroidx/slidingpanelayout/widget/SlidingPaneLayout;)V", "handleOnBackPressed", "", "onPanelClosed", "panel", "Landroid/view/View;", "onPanelOpened", "onPanelSlide", "slideOffset", "", "navigation-fragment_release"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    private static final class InnerOnBackPressedCallback extends OnBackPressedCallback implements SlidingPaneLayout.PanelSlideListener {
        ...
        public InnerOnBackPressedCallback(SlidingPaneLayout slidingPaneLayout) {
            ...
            this.slidingPaneLayout.addPanelSlideListener(this);
        }
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        FragmentContainerView $this$onCreateView_u24lambda_u243 = new FragmentContainerView(context);
        $this$onCreateView_u24lambda_u243.setId(R.id.sliding_pane_detail_container);
        int detailWidth = inflater.getContext().getResources().getDimensionPixelSize(R.dimen.sliding_pane_detail_pane_width);
        SlidingPaneLayout.LayoutParams $this$onCreateView_u24lambda_u244 = new SlidingPaneLayout.LayoutParams(detailWidth, -1);
        $this$onCreateView_u24lambda_u244.weight = 1.0f;
        slidingPaneLayout.addView($this$onCreateView_u24lambda_u243, $this$onCreateView_u24lambda_u244);
        ...
        if (existingNavHostFragment != null) {
            ...
            FragmentTransaction $this$onCreateView_u24lambda_u246_u24lambda_u245 = childFragmentManager.beginTransaction();
            Intrinsics.checkNotNullExpressionValue($this$onCreateView_u24lambda_u246_u24lambda_u245, "beginTransaction()");
            $this$onCreateView_u24lambda_u246_u24lambda_u245.setReorderingAllowed(true);
            $this$onCreateView_u24lambda_u246_u24lambda_u245.add(R.id.sliding_pane_detail_container, newNavHostFragment);
            $this$onCreateView_u24lambda_u246_u24lambda_u245.commit();
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if (this.graphId != 0) {
            outState.putInt(NavHostFragment.KEY_GRAPH_ID, this.graphId);
        }
    }
}
