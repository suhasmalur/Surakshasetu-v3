...
public class NavController {
    ...
    public static final void lifecycleObserver$lambda$2(NavController this$0, LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
        ...
        if (this$0._graph != null) {
            for (NavBackStackEntry entry : this$0.backQueue) {
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public boolean handleDeepLink(android.content.Intent r27) throws android.content.pm.PackageManager.NameNotFoundException {
        /*
    ...
    */
    ...
    private final boolean executeRestoreState(final List<NavBackStackEntry> entries, final Bundle args, NavOptions navOptions, Navigator.Extras navigatorExtras) {
        ...
        for (List<NavBackStackEntry> list : entriesGroupedByNavigator) {
            ...
            navigateInternal(navigator, list, navOptions, navigatorExtras, new Function1<NavBackStackEntry, Unit>() { // from class: androidx.navigation.NavController.executeRestoreState.3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(NavBackStackEntry entry2) {
                    ...
                    this.addEntryToBackStack(entry2.getDestination(), args, entry2, listEmptyList);
                }
            });
        }
    ...
    public final void addEntryToBackStack(NavDestination node, Bundle finalArgs, NavBackStackEntry backStackEntry, List<NavBackStackEntry> restoredEntries) {
        ...
        while (destination5 != null && findDestination(destination5.getId()) != destination5) {
        ...
        while (!this.backQueue.isEmpty() && (this.backQueue.last().getDestination() instanceof NavGraph)) {
            NavDestination destination6 = this.backQueue.last().getDestination();
            Intrinsics.checkNotNull(destination6, "null cannot be cast to non-null type androidx.navigation.NavGraph");
            if (((NavGraph) destination6).findNode(overlappingDestination.getId(), false) != null) {
                break;
            } else {
                popEntryFromBackStack$default(this, this.backQueue.last(), false, null, 6, null);
            }
        ...
        if (!Intrinsics.areEqual(firstEntry != null ? firstEntry.getDestination() : null, this._graph)) {
            ...
            while (true) {
                ...
                NavDestination destination7 = restoredEntry3.getDestination();
                NavGraph navGraph = this._graph;
                Intrinsics.checkNotNull(navGraph);
                if (Intrinsics.areEqual(destination7, navGraph)) {
                    obj = element$iv3;
                    break;
                }
            }
    ...
    public Bundle saveState() {
        ...
        if (!arrayList.isEmpty()) {
            b = new Bundle();
            navigatorState.putStringArrayList(KEY_NAVIGATOR_STATE_NAMES, arrayList);
        ...
        if (!this.backStackMap.isEmpty()) {
            ...
            b.putStringArrayList(KEY_BACK_STACK_IDS, arrayList2);
        }
        if (!this.backStackStates.isEmpty()) {
            ...
            for (Map.Entry<String, ArrayDeque<NavBackStackEntryState>> entry3 : this.backStackStates.entrySet()) {
                ...
                arrayList3.add(id2);
                Parcelable[] states = new Parcelable[value.size()];
                ArrayDeque<NavBackStackEntryState> $this$forEachIndexed$iv = value;
                int stateIndex = 0;
                for (Object item$iv : $this$forEachIndexed$iv) {
            ...
            b.putStringArrayList(KEY_BACK_STACK_STATES_IDS, arrayList3);
        }
        if (this.deepLinkHandled) {
            if (b == null) {
                b = new Bundle();
    ...
    public void restoreState(Bundle navState) {
        ...
        if (backStackDestIds2 != null && stringArrayList != null) {
            int index$iv = 0;
            int length = backStackDestIds2.length;
            int i = 0;
            while (i < length) {
                int item$iv = backStackDestIds2[i];
                this.backStackMap.put(Integer.valueOf(item$iv), stringArrayList.get(index$iv));
                i++;
                index$iv++;
            }
        }
        Iterable stringArrayList2 = navState.getStringArrayList(KEY_BACK_STACK_STATES_IDS);
        if (stringArrayList2 != null) {
            Iterable $this$forEach$iv = stringArrayList2;
            for (Object element$iv : $this$forEach$iv) {
                ...
                if (backStackState == null) {
                    ...
                    Intrinsics.checkNotNullExpressionValue(id, "id");
                    ArrayDeque<NavBackStackEntryState> arrayDeque = new ArrayDeque<>(backStackState.length);
