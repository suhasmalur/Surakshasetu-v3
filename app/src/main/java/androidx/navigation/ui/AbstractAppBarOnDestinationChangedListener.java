...
public abstract class AbstractAppBarOnDestinationChangedListener implements NavController.OnDestinationChangedListener {
    ...
    public AbstractAppBarOnDestinationChangedListener(Context context, AppBarConfiguration configuration) {
        ...
        this.openableLayoutWeakReference = $this$openableLayoutWeakReference_u24lambda_u240 != null ? new WeakReference<>($this$openableLayoutWeakReference_u24lambda_u240) : null;
    }
    ...
    public void onDestinationChanged(NavController controller, NavDestination destination, Bundle arguments) {
        ...
        Openable openableLayout = weakReference != null ? weakReference.get() : null;
    ...
    private final void setActionBarUpIndicator(boolean showAsDrawerIndicator) {
        ...
        if (animate) {
            ...
            this.animator = ObjectAnimator.ofFloat(arrow, "progress", startValue, endValue);
