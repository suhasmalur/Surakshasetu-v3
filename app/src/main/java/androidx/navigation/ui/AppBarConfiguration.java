...
public final class AppBarConfiguration {
    ...
    /* JADX INFO: compiled from: AppBarConfiguration.kt */
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0000\bæ\u0080\u0001\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H&ø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001¨\u0006\u0004À\u0006\u0001"}, d2 = {"Landroidx/navigation/ui/AppBarConfiguration$OnNavigateUpListener;", "", "onNavigateUp", "", "navigation-ui_release"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    ...
    public final DrawerLayout getDrawerLayout() {
        if (this.openableLayout instanceof DrawerLayout) {
            return (DrawerLayout) this.openableLayout;
        }
        return null;
    }
    ...
    public final boolean isTopLevelDestination(NavDestination destination) {
        ...
        do {
            ...
            if (this.topLevelDestinations.contains(Integer.valueOf(parent.getId()))) {
                if (parent instanceof NavGraph) {
                    if (destination.getId() == NavGraph.INSTANCE.findStartDestination((NavGraph) parent).getId()) {
                        z = true;
                    }
                } else {
                    z = true;
    ...
    public static final class Builder {
        ...
        public Builder(NavGraph navGraph) {
            ...
            this.topLevelDestinations.add(Integer.valueOf(NavGraph.INSTANCE.findStartDestination(navGraph).getId()));
        }
        ...
        public Builder(Set<Integer> topLevelDestinationIds) {
            Intrinsics.checkNotNullParameter(topLevelDestinationIds, "topLevelDestinationIds");
            this.topLevelDestinations = new HashSet();
            this.topLevelDestinations.addAll(topLevelDestinationIds);
        }
