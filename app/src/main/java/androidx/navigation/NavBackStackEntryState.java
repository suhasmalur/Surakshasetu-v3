...
public final class NavBackStackEntryState implements Parcelable {
    ...
    public final NavBackStackEntry instantiate(Context context, NavDestination destination, Lifecycle.State hostLifecycleState, NavControllerViewModel viewModel) {
        ...
        Bundle $this$instantiate_u24lambda_u240 = this.args;
        if ($this$instantiate_u24lambda_u240 != null) {
            $this$instantiate_u24lambda_u240.setClassLoader(context.getClassLoader());
        } else {
            $this$instantiate_u24lambda_u240 = null;
        }
        Bundle args = $this$instantiate_u24lambda_u240;
