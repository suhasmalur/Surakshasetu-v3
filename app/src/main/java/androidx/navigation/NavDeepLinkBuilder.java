...
public final class NavDeepLinkBuilder {
    ...
    public NavDeepLinkBuilder(Context context) {
        ...
        if (this.context instanceof Activity) {
            launchIntent = new Intent(this.context, this.context.getClass());
        } else {
