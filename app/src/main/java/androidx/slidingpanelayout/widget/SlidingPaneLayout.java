...
public class SlidingPaneLayout extends ViewGroup implements Openable {
    ...
    /* JADX WARN: Removed duplicated region for block: B:21:0x008d A[PHI: r8
      0x008d: PHI (r8v2 'weightSum' float) = (r8v1 'weightSum' float), (r8v11 'weightSum' float) binds: [B:17:0x0080, B:19:0x0087] A[DONT_GENERATE, DONT_INLINE]] */
