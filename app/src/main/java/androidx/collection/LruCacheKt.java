...
public final class LruCacheKt {
    public static /* synthetic */ LruCache lruCache$default(int maxSize, Function2 sizeOf, Function1 create, Function4 onEntryRemoved, int i, Object obj) {
        ...
        return new AnonymousClass4(sizeOf, create, onEntryRemoved, maxSize, maxSize);
    }
    ...
    public static final class AnonymousClass4<K, V> extends LruCache<K, V> {
        ...
        public AnonymousClass4(Function2 $captured_local_variable$0, Function1 $captured_local_variable$1, Function4 $captured_local_variable$2, int $captured_local_variable$3, int $super_call_param$4) {
