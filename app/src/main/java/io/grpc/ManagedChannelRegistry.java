...
public final class ManagedChannelRegistry {
    ...
    ManagedChannelBuilder<?> newChannelBuilder(NameResolverRegistry nameResolverRegistry, String target, ChannelCredentials creds) {
        ...
        if (nameResolverProvider == null) {
            NameResolverProvider nameResolverProvider2 = nameResolverRegistry.providers().get(nameResolverRegistry.asFactory().getDefaultScheme());
            nameResolverProvider = nameResolverProvider2;
        }
        if (nameResolverProvider != null) {
