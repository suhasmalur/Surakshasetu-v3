...
public final class LocalSerializer {
    ...
    TargetData decodeTargetData(Target targetProto) {
        ...
        switch (targetProto.getTargetTypeCase()) {
            case DOCUMENTS:
                com.google.firebase.firestore.core.Target target2 = this.rpcSerializer.decodeDocumentsTarget(targetProto.getDocuments());
                target = target2;
                break;
            case QUERY:
                com.google.firebase.firestore.core.Target target3 = this.rpcSerializer.decodeQueryTarget(targetProto.getQuery());
                target = target3;
                break;
            default:
