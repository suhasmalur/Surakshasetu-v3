...
final class zzfh extends zzfk {
    ...
    public final void zzg(int i) throws IOException {
        try {
            ...
            throw new zzfi(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zze), Integer.valueOf(this.zzd), 1), e);
        }
    }
    ...
    public final void zzn(String str) throws IOException {
        ...
        try {
            ...
            int i3 = i + iZzy2;
            this.zze = i3;
            int iZzb = zzju.zzb(str, this.zzc, i3, this.zzd - i3);
            this.zze = i;
            zzq((iZzb - i) - iZzy2);
            this.zze = iZzb;
        } catch (zzjt e) {
    ...
    public final void zzc(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zzfi(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zze), Integer.valueOf(this.zzd), Integer.valueOf(i2)), e);
        }
    }
    ...
    public final void zzs(long j) throws IOException {
        if (zzfk.zzd && this.zzd - this.zze >= 10) {
            while ((j & (-128)) != 0) {
                ...
                int i = this.zze;
                this.zze = i + 1;
                zzjp.zzn(bArr, i, (byte) ((((int) j) & WorkQueueKt.MASK) | 128));
                j >>>= 7;
            }
            byte[] bArr2 = this.zzc;
            int i2 = this.zze;
