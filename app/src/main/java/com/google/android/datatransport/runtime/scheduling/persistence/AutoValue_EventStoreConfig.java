...
final class AutoValue_EventStoreConfig extends EventStoreConfig {
    ...
    public int hashCode() {
        int h$ = 1 * 1000003;
        return ((((((((h$ ^ ((int) ((this.maxStorageSizeInBytes >>> 32) ^ this.maxStorageSizeInBytes))) * 1000003) ^ this.loadBatchSize) * 1000003) ^ this.criticalSectionEnterTimeoutMs) * 1000003) ^ ((int) ((this.eventCleanUpAge >>> 32) ^ this.eventCleanUpAge))) * 1000003) ^ this.maxBlobByteSizePerRow;
    }
    ...
    static final class Builder extends EventStoreConfig.Builder {
        ...
        EventStoreConfig build() {
            String missing = this.maxStorageSizeInBytes == null ? " maxStorageSizeInBytes" : "";
