...
public class WakeLock {
    ...
    public WakeLock(Context context, int levelAndFlags, String wakeLockName) {
        ...
        if ("com.google.android.gms".equals(context.getPackageName())) {
            ...
            String strValueOf = String.valueOf(wakeLockName);
        ...
        this.zzg = powerManager.newWakeLock(levelAndFlags, wakeLockName);
        if (WorkSourceUtil.hasWorkSourcePermission(context)) {
            this.zzo = WorkSourceUtil.fromPackage(context, Strings.isEmptyOrWhitespace(packageName) ? context.getPackageName() : packageName);
    ...
    public void acquire(long timeout) {
        ...
        synchronized (this.zzf) {
            ...
            long j = Long.MAX_VALUE - jElapsedRealtime > jMax ? jElapsedRealtime + jMax : Long.MAX_VALUE;
            if (j > this.zzj) {
                this.zzj = j;
                Future<?> future = this.zzi;
                if (future != null) {
