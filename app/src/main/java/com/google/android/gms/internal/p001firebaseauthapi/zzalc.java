...
interface zzalc {
    ...
    <T> void zza(T t, zzalf<T> zzalfVar, zzaio zzaioVar) throws IOException;

    void zza(List<Boolean> list) throws IOException;

    @Deprecated
    <T> void zza(List<T> list, zzalf<T> zzalfVar, zzaio zzaioVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzake<K, V> zzakeVar, zzaio zzaioVar) throws IOException;

    float zzb() throws IOException;

    <T> void zzb(T t, zzalf<T> zzalfVar, zzaio zzaioVar) throws IOException;

    void zzb(List<zzahp> list) throws IOException;

    <T> void zzb(List<T> list, zzalf<T> zzalfVar, zzaio zzaioVar) throws IOException;
