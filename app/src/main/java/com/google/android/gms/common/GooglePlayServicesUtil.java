...
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight {
    ...
    public static boolean showErrorDialogFragment(int errorCode, Activity activity, Fragment fragment, int requestCode, DialogInterface.OnCancelListener cancelListener) {
        ...
        Dialog dialogZaa = googleApiAvailability.zaa(activity, errorCode, zag.zac(fragment, GoogleApiAvailability.getInstance().getErrorResolutionIntent(activity, errorCode, "d"), requestCode), cancelListener);
        if (dialogZaa == null) {
            return false;
        }
