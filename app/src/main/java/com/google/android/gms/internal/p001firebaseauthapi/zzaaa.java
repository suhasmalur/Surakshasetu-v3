...
final class zzaaa implements zzadk<zzagh> {
    ...
    zzaaa(zzyj zzyjVar, zzacd zzacdVar) {
        this.zzb = zzyjVar;
        this.zza = zzacdVar;
    }
    ...
    public final /* synthetic */ void zza(zzagh zzaghVar) {
        ...
        this.zzb.zza(new zzafn(zzaghVar2.zzc(), zzaghVar2.zzb(), Long.valueOf(zzaghVar2.zza()), "Bearer"), null, null, true, null, this.zza, this);
    }
}
