...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        public final ClientSettings zaa() {
            return new ClientSettings(this.zaa, this.zab, this.zah, this.zad, this.zae, this.zaf, this.zag, this.zaj.containsKey(com.google.android.gms.signin.zad.zag) ? (SignInOptions) this.zaj.get(com.google.android.gms.signin.zad.zag) : SignInOptions.zaa, false);
        }
