...
public class GoogleMap {
    ...
    public final GroundOverlay addGroundOverlay(GroundOverlayOptions options) {
        try {
            ...
            com.google.android.gms.internal.maps.zzr zzrVarAddGroundOverlay = this.zza.addGroundOverlay(options);
            if (zzrVarAddGroundOverlay != null) {
                return new GroundOverlay(zzrVarAddGroundOverlay);
            }
            return null;
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
    ...
    public final Marker addMarker(MarkerOptions options) {
        ...
        try {
            ...
            com.google.android.gms.internal.maps.zzad zzadVarAddMarker = this.zza.addMarker(options);
            if (zzadVarAddMarker != null) {
                return options.zzb() == 1 ? new AdvancedMarker(zzadVarAddMarker) : new Marker(zzadVarAddMarker);
            }
            return null;
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
    ...
    public final TileOverlay addTileOverlay(TileOverlayOptions options) {
        try {
            ...
            com.google.android.gms.internal.maps.zzam zzamVarAddTileOverlay = this.zza.addTileOverlay(options);
            if (zzamVarAddTileOverlay != null) {
                return new TileOverlay(zzamVarAddTileOverlay);
            }
            return null;
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
