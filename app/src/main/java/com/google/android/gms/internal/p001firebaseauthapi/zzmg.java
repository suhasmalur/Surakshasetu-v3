...
public final class zzmg {
    ...
    private static zzmj zza(zzmj zzmjVar, zzmj zzmjVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger bigIntegerMod = zzmjVar.zzd.multiply(zzmjVar.zzd).mod(bigInteger2);
        BigInteger bigIntegerMod2 = zzmjVar2.zzd.multiply(zzmjVar2.zzd).mod(bigInteger2);
        BigInteger bigIntegerMod3 = zzmjVar.zzb.multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod4 = zzmjVar2.zzb.multiply(bigIntegerMod).mod(bigInteger2);
        BigInteger bigIntegerMod5 = zzmjVar.zzc.multiply(zzmjVar2.zzd).mod(bigInteger2).multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod6 = zzmjVar2.zzc.multiply(zzmjVar.zzd).mod(bigInteger2).multiply(bigIntegerMod).mod(bigInteger2);
        if (bigIntegerMod3.equals(bigIntegerMod4)) {
            return !bigIntegerMod5.equals(bigIntegerMod6) ? zzmj.zza : zza(zzmjVar, bigInteger, bigInteger2);
        }
        ...
        BigInteger bigIntegerMod10 = bigIntegerMod6.subtract(bigIntegerMod5).multiply(zzd).mod(bigInteger2);
        BigInteger bigIntegerMod11 = bigIntegerMod3.multiply(bigIntegerMod8).mod(bigInteger2);
        BigInteger bigIntegerMod12 = bigIntegerMod10.multiply(bigIntegerMod10).mod(bigInteger2).subtract(bigIntegerMod9).subtract(bigIntegerMod11.multiply(zzd)).mod(bigInteger2);
        BigInteger bigIntegerMod13 = bigIntegerMod10.multiply(bigIntegerMod11.subtract(bigIntegerMod12)).subtract(bigIntegerMod5.multiply(zzd).multiply(bigIntegerMod9)).mod(bigInteger2);
        BigInteger bigIntegerAdd = zzmjVar.zzd.add(zzmjVar2.zzd);
        return new zzmj(bigIntegerMod12, bigIntegerMod13, bigIntegerAdd.multiply(bigIntegerAdd).mod(bigInteger2).subtract(bigIntegerMod).subtract(bigIntegerMod2).multiply(bigIntegerMod7).mod(bigInteger2));
    }
    ...
    private static zzmj zza(zzmj zzmjVar, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger bigIntegerMod = zzmjVar.zzb.multiply(zzmjVar.zzb).mod(bigInteger2);
        BigInteger bigIntegerMod2 = zzmjVar.zzc.multiply(zzmjVar.zzc).mod(bigInteger2);
        BigInteger bigIntegerMod3 = bigIntegerMod2.multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod4 = zzmjVar.zzd.multiply(zzmjVar.zzd).mod(bigInteger2);
        BigInteger bigIntegerAdd = zzmjVar.zzb.add(bigIntegerMod2);
        BigInteger bigIntegerMultiply = bigIntegerAdd.multiply(bigIntegerAdd).mod(bigInteger2).subtract(bigIntegerMod).subtract(bigIntegerMod3).multiply(zzd);
        ...
        BigInteger bigIntegerMod5 = bigIntegerAdd2.multiply(bigIntegerAdd2).mod(bigInteger2).subtract(bigIntegerMultiply.multiply(zzd)).mod(bigInteger2);
        ...
        BigInteger bigIntegerAdd3 = zzmjVar.zzc.add(zzmjVar.zzd);
        return new zzmj(bigIntegerMod5, bigIntegerMod6, bigIntegerAdd3.multiply(bigIntegerAdd3).mod(bigInteger2).subtract(bigIntegerMod2).subtract(bigIntegerMod4).mod(bigInteger2));
    }
    ...
    private static zzmj zza(ECPoint eCPoint, BigInteger bigInteger) {
        ...
        BigInteger bigIntegerMod = new BigInteger(1, zzou.zza((bigInteger.bitLength() + 8) / 8)).mod(bigInteger);
        BigInteger bigIntegerMod2 = bigIntegerMod.multiply(bigIntegerMod).mod(bigInteger);
        return new zzmj(eCPoint.getAffineX().multiply(bigIntegerMod2).mod(bigInteger), eCPoint.getAffineY().multiply(bigIntegerMod2.multiply(bigIntegerMod).mod(bigInteger)).mod(bigInteger), bigIntegerMod);
    }
    ...
    public static ECPoint zza(BigInteger bigInteger, ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        ...
        zzmj zzmjVarZza = zza(ECPoint.POINT_INFINITY, bigIntegerZza);
        zzmj zzmjVarZza2 = zza(generator, bigIntegerZza);
        for (int iBitLength = bigInteger.bitLength(); iBitLength >= 0; iBitLength--) {
            if (bigInteger.testBit(iBitLength)) {
                zzmjVarZza = zza(zzmjVarZza, zzmjVarZza2, a, bigIntegerZza);
                zzmjVarZza2 = zza(zzmjVarZza2, a, bigIntegerZza);
            } else {
                zzmjVarZza2 = zza(zzmjVarZza, zzmjVarZza2, a, bigIntegerZza);
                zzmjVarZza = zza(zzmjVarZza, a, bigIntegerZza);
            }
        }
        if (zzmjVarZza.zza()) {
            eCPoint = ECPoint.POINT_INFINITY;
        } else {
            BigInteger bigIntegerModInverse = zzmjVarZza.zzd.modInverse(bigIntegerZza);
            BigInteger bigIntegerMod = bigIntegerModInverse.multiply(bigIntegerModInverse).mod(bigIntegerZza);
            eCPoint = new ECPoint(zzmjVarZza.zzb.multiply(bigIntegerMod).mod(bigIntegerZza), zzmjVarZza.zzc.multiply(bigIntegerMod).mod(bigIntegerZza).multiply(bigIntegerModInverse).mod(bigIntegerZza));
        }
        zza(eCPoint, curve);
        return eCPoint;
    }
