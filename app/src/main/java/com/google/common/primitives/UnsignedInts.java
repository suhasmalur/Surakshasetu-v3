...
public final class UnsignedInts {
    ...
    public static int decode(String stringValue) {
        ...
        try {
            ...
            NumberFormatException decodeException = new NumberFormatException(strValueOf.length() != 0 ? "Error parsing value: ".concat(strValueOf) : new String("Error parsing value: "));
    ...
    public static int parseUnsignedInt(String string, int radix) {
        ...
        if ((INT_MASK & result) != result) {
            throw new NumberFormatException(new StringBuilder(String.valueOf(string).length() + 69).append("Input ").append(string).append(" in base ").append(radix).append(" is not in the range of an unsigned integer").toString());
        }
        return (int) result;
    }
