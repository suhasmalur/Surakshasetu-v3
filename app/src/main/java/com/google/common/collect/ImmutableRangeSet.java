    ...
    private ImmutableList<Range<C>> intersectRanges(final Range<C> range) {
        ...
        return (ImmutableList<Range<C>>) new ImmutableList<Range<C>>() { // from class: com.google.common.collect.ImmutableRangeSet.1
            ...
            public Range<C> get(int index) {
                ...
                return (index == 0 || index == i + (-1)) ? ((Range) ImmutableRangeSet.this.ranges.get(iBinarySearch + index)).intersection(range) : (Range) ImmutableRangeSet.this.ranges.get(iBinarySearch + index);
            }
