...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    static IllegalArgumentException conflictException(String conflictDescription, Object entry1, Object entry2) {
        String strValueOf = String.valueOf(entry1);
        String strValueOf2 = String.valueOf(entry2);
        return new IllegalArgumentException(new StringBuilder(String.valueOf(conflictDescription).length() + 34 + String.valueOf(strValueOf).length() + String.valueOf(strValueOf2).length()).append("Multiple entries with same ").append(conflictDescription).append(": ").append(strValueOf).append(" and ").append(strValueOf2).toString());
    }
