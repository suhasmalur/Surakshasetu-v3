...
public abstract class AbstractService implements Service {
    ...
    private static ListenerCallQueue.Event<Service.Listener> terminatedEvent(final Service.State from) {
        return new ListenerCallQueue.Event<Service.Listener>() { // from class: com.google.common.util.concurrent.AbstractService.3
            ...
            public String toString() {
                String strValueOf = String.valueOf(from);
        ...
        if (this.monitor.enterIf(this.isStoppable)) {
            try {
                ...
                switch (previous) {
                    ...
                    case TERMINATED:
                    case FAILED:
                        String strValueOf = String.valueOf(previous);
    ...
    private void checkCurrentState(Service.State expected) {
        ...
        if (actual != expected) {
            if (actual == Service.State.FAILED) {
                String strValueOf = String.valueOf(this);
                String strValueOf2 = String.valueOf(expected);
            ...
            String strValueOf4 = String.valueOf(expected);
            String strValueOf5 = String.valueOf(actual);
    ...
    protected final void notifyStarted() {
        ...
        try {
            if (this.snapshot.state != Service.State.STARTING) {
                ...
                IllegalStateException failure = new IllegalStateException(new StringBuilder(String.valueOf(strValueOf).length() + 43).append("Cannot notifyStarted() when the service is ").append(strValueOf).toString());
    ...
    protected final void notifyFailed(Throwable cause) {
        ...
        try {
            ...
            switch (previous) {
                ...
                case TERMINATED:
                    String strValueOf = String.valueOf(previous);
                    throw new IllegalStateException(new StringBuilder(String.valueOf(strValueOf).length() + 22).append("Failed while in state:").append(strValueOf).toString(), cause);
                case STARTING:
                case RUNNING:
                case STOPPING:
    ...
    private void enqueueFailedEvent(final Service.State from, final Throwable cause) {
        this.listeners.enqueue(new ListenerCallQueue.Event<Service.Listener>(this) { // from class: com.google.common.util.concurrent.AbstractService.5
            ...
            public String toString() {
                String strValueOf = String.valueOf(from);
                String strValueOf2 = String.valueOf(cause);
