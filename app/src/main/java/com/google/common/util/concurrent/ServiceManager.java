    ...
    private static final class ServiceManagerState {
        ...
        void markReady() {
            ...
            try {
                ...
                String strValueOf = String.valueOf(servicesInBadStates);
        ...
        ImmutableMap<Service, Long> startupTimes() {
            ...
            try {
                ...
                this.monitor.leave();
                Collections.sort(loadTimes, Ordering.natural().onResultOf(new Function<Map.Entry<Service, Long>, Long>(this) { // from class: com.google.common.util.concurrent.ServiceManager.ServiceManagerState.1
        ...
        void checkHealthy() {
            if (this.states.count(Service.State.RUNNING) != this.numberOfServices) {
                ...
                IllegalStateException exception = new IllegalStateException(new StringBuilder(String.valueOf(strValueOf).length() + 79).append("Expected to be healthy after starting. The following services are not running: ").append(strValueOf).toString());
                throw exception;
            }
        }
    }
        ...
        public void failed(Service.State from, Throwable failure) {
            ...
            if (state != null) {
                ...
                if (log) {
                    ...
                    logger.log(level, new StringBuilder(String.valueOf(strValueOf).length() + 34 + String.valueOf(strValueOf2).length()).append("Service ").append(strValueOf).append(" has failed in the ").append(strValueOf2).append(" state.").toString(), failure);
                }
