...
final class FuturesGetChecked {
    ...
    private static <X extends Exception> X newWithCause(Class<X> exceptionClass, Throwable cause) {
        ...
        String strValueOf = String.valueOf(exceptionClass);
        throw new IllegalArgumentException(new StringBuilder(String.valueOf(strValueOf).length() + 82).append("No appropriate constructor for exception of type ").append(strValueOf).append(" in response to chained exception").toString(), cause);
    }
