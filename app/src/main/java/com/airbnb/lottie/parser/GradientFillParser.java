...
class GradientFillParser {
    ...
    static GradientFill parse(JsonReader reader, LottieComposition composition) throws IOException {
        ...
        return new GradientFill(name, gradientType, fillType, color, opacity == null ? new AnimatableIntegerValue(Collections.singletonList(new Keyframe(100))) : opacity, startPoint, endPoint, null, null, hidden);
    }
}
